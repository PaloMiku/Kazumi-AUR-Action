# animeko-appimage-beta

[animeko-appimage-beta](https://aur.archlinux.org/packages/animeko-appimage-beta) - '集找番、追番、看番的一站式弹幕追番平台（Beta 版）'
...
```bash
cd packages/animeko-appimage-beta
makepkg -si
```
